 ...
 */
public abstract class AbstractQuarkRoutingDataSource extends AbstractDataSource implements InitializingBean {
	...
	/**
	 * 向数据源容器中添加数据源.
	 * @param lookupKey		数据库标识.
	 * @param dataSource	数据源.
	 */
	protected void addDataSource(String lookupKey, DataSource dataSource) {
	...
	/**
	 * 通过数据源标识判断数据源容器中是否有对应的数据源.
	 * @param lookupKey	数据库标识.
	 * @return	true:存在、false:不存在.
	 */
	protected boolean isExist(String lookupKey) {
